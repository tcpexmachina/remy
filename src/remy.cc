...
int main( int argc, char *argv[] )
{
  ...
  configuration_range.link_packets_per_ms = make_pair( 1.0, 10.0 ); /* 10--100 Mbps */
  configuration_range.rtt_ms = make_pair( 10, 280 ); /* ms */
  configuration_range.max_senders = 20;
