...
int main( int argc, char *argv[] )
{
  ...
  ProblemBuffers::Problem serialized_problem = eval.serialize_problem( whiskers, false, 10 );
  ...
  auto outcome = Evaluator::parse_problem_and_score( problem );
  ...
  AnswerBuffers::Outcome serialized_answer = Evaluator::serialize_answer( outcome  );
  char of_a[ 128 ];
  ...
  auto parsed_outcome = Evaluator::parse_answer( proto_outcome );
  printf( "score = %f\n", outcome.score );
  double norm_score = 0;
