...
public:
  ...
  const DataType & field( unsigned int num ) const { return num == 0 ? _rec_rec_ewma : num == 1 ? _rtt_ratio : num == 2 ? _rtt_ratio : _slow_rec_rec_ewma ; }
  DataType & mutable_field( unsigned int num )     { return num == 0 ? _rec_rec_ewma : num == 1 ? _rtt_ratio : num == 2 ? _rtt_ratio : _slow_rec_rec_ewma ; }
