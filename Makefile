source = link.cc receiver.cc window-tester.cc random.cc window-sender.cc sendergang.cc rat.cc remy.cc window-sender-templates.cc rat-templates.cc link-templates.cc network.cc emil-tester.cc emil.cc emil-templates.cc whisker.cc memory.cc memoryrange.cc evaluator.cc dna.pb.cc ratbreeder.cc rat-runner.cc rat-printer.cc
...
executables = window-tester remy emil-tester rat-runner rat-printer
CXX = g++
LANGFLAGS = -std=c++0x
...
rat-printer: rat-printer.o $(objects)
	$(CXX) $(CXXFLAGS) -o $@ $+ $(LIBS)
